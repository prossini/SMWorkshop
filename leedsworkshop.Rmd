...
```{r twitter oauth, eval=FALSE, include=TRUE, message=FALSE, inspect=FALSE}
...
```{r inspect, include=TRUE, eval=FALSE, inspect=FALSE}
head(leaders)
```
...
This first part was about inspecting the data and understanding what we collected, as well as filtering data by the created date to narrow down our tweets to 2022. 
